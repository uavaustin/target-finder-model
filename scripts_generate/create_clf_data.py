...
def create_clf_images(gen_type, num_gen, offset=0):
    ...
    data = zip(numbers, backgrounds, crop_xs, crop_ys, flip_bg, mirror_bg, blurs, enhancements, shape_imgs, gen_types)
...
def _single_clf_image(data):
    ...
    number, background, crop_x, crop_y, flip_bg, mirror_bg, blur, enhancement, shape_img, gen_type = data
